...
<ul>
<li><i class="fas fa-music"></i><span style="font-weight: bold; text-decoration: underline;">MP3
Player/ Radio</span>: Want to listen to a song? Tap the App and
listen online. Who uses walkman in 2018? Almost none.</li>
</ul>
<ul>
<li><i class="fas fa-calculator"></i><span style="font-weight: bold; text-decoration: underline;">Calculator</span>:
According to recent survey sale of calculators gone
down by 72 %, Do I need to say anymore?&nbsp;</li>
</ul>
<ul>
<li><i class="fas fa-map-marker-alt"></i><span style="font-weight: bold; text-decoration: underline;">GPS</span>:
Very much popular at the moment. Lost the plot. Is no one
around to ask? No worries. Just open the map and navigate like a
Columbus may be.</li>
</ul>
<ul>
<li><i class="fal fa-scanner"></i><span style="font-weight: bold; text-decoration: underline;">Scanner</span>:
...
<ul>
<li><i class="fab fa-usb"></i><span style="font-weight: bold; text-decoration: underline;">Flash
...
<ul>
<li><i class="fas fa-sticky-note"></i><span style="font-weight: bold; text-decoration: underline;">Notepad/
